      ...
      <div className="flex-1">
        <div className="relative hidden sm:block max-w-xs">
          <input
            ...
            className="h-9 w-full rounded-lg border border-[color:var(--glass-border)] bg-[color:var(--glass-bg)] px-3 py-2 text-sm text-muted-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ci-orange"
          />
        </div>
      </div>
